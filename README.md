...
To install, run [``setup.m``](https://github.com/Ya-Za/dagnn/blob/master/setup.m) in the directory where you want to install the program. The output will let you know whether you will need any additional toolboxes.
